...
if "%VS_VER%"=="2022" (
    set "CONFIGURE_PRESET=vs2022-debug-x64"
    set "BUILD_PRESET=build-vs2022-debug-x64"
) else (
    set "CONFIGURE_PRESET=vs2026-debug-x64"
    set "BUILD_PRESET=build-vs2026-debug-x64"
)
